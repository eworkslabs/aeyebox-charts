      ...
      case 'Company':
        return (
          <div className="grid grid-cols-2 gap-4">
            <div>
              <input type="text" placeholder='Name of Company' className="w-full border rounded p-2" />
            </div>
          </div>
        );
      case 'Location':
        return (
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <input type="text" placeholder='Location Name' className="w-full border rounded p-2" />
            </div>
          </div>
        );
      case 'Plants':
        return (
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <input type="text" placeholder='Plant Name' className="w-full border rounded p-2" />
            </div>
          </div>
        );
      case 'Line':
        return (
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <input type="text" placeholder='Line Name' className="w-full border rounded p-2" />
            </div>
          </div>
        );
      case 'Machine':
      ...
      <div className="bg-white rounded-lg p-6 w-[600px]">
        ...
        <div className="border-b mb-4 pb-2">
          <ul className="flex space-x-4">
            {['Company', 'Location', 'Plants', 'Line', 'Machine'].map(tab => (
              <li
                key={tab}
