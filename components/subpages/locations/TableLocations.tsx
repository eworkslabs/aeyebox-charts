      ...
      <div className="overflow-x-auto rounded-t-lg">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-[#07314a] text-white">
            <tr>
              <th className="w-1/3 px-2 py-3 text-left xs:text-[13px] text-base md:text-lg font-medium">Locations</th>
              <th className="w-1/3 px-2 py-3 text-left xs:text-[13px] text-base md:text-lg font-medium">Company</th>
