        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-[#07314a] text-white">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-lg font-medium">Lines</th>
              <th className="px-6 py-3 text-left text-lg font-medium">Machines</th>
          ...
          <tbody className="bg-white divide-y divide-gray-300">
            <tr className="bg-slate-100">
              ...
              <td className="px-6 py-4 text-lg font-medium">Plant</td>
              <td className="px-6 py-4 text-lg font-medium">Line</td>
              <td className="px-6 py-4 text-lg font-medium">Machine</td>
