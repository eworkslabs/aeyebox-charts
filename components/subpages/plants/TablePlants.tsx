        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-[#07314a] text-white">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-lg font-medium">Plants</th>
          ...
          <tbody className="bg-white divide-y divide-gray-300">
            <tr className="bg-slate-100">
              ...
              <td className="px-6 py-4 text-lg font-medium">Plant 1</td>
            ...
            <tr>
              ...
              <td className="px-6 py-4 text-lg font-medium">Plant 2</td>
            ...
            <tr className="bg-slate-100">
              ...
              <td className="px-6 py-4 text-lg font-medium">Plant C</td>
              <td className="px-6 py-4 text-lg font-medium">1</td>
            </tr>
            <tr>
              <td className="px-6 py-4 text-lg font-medium">Hyderabad, Telangana, India</td>
              <td className="px-6 py-4 text-lg font-medium">Acme Co.</td>
              <td className="px-6 py-4 text-lg font-medium">Plant 4</td>
            ...
            <tr className="bg-slate-100">
              ...
              <td className="px-6 py-4 text-lg font-medium">Plant E</td>
              <td className="px-6 py-4 text-lg font-medium">0</td>
            </tr>
            <tr>
